...
In order to understand what you are doing, it is best read the complete contents of this document and follow the instructions herein. And if there are problems you will be able to reason about the errors. However, if you are champing at the bit, you can run the following commands to quickly get you going.
 ...
 #+BEGIN_SRC org :noweb yes :results append :exports results 
   ...
   - =ssh ubuntu@<<myvm>>.cloudapp.net "bash -s" < Unidata-Dockerfiles/ams2016/unicloud-2.sh= (this will take few minutes)
#+END_SRC
...
#+BEGIN_SRC sh :eval no :results silent :noweb yes :exports none
...
#+BEGIN_SRC org :noweb yes :dir ~ :tangle ../unicloud-1.sh :shebang "#!/bin/bash"  :exports none :eval no
set -x 
...
#+BEGIN_SRC org :noweb yes :dir ~ :tangle ../unicloud-1.sh  :exports none :eval no
