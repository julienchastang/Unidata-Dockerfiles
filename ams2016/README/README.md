...
<ul>
<li><a href="#orgheadline1">1.1. Quick Start</a></li>
<li><a href="#orgheadline3">1.2. Preamble</a>
<ul>
<li><a href="#orgheadline2">1.2.1. <code>docker-machine</code></a></li>
</ul>
</li>
<li><a href="#orgheadline12">1.3. Preliminary Setup on Azure</a>
<ul>
<li><a href="#orgheadline4">1.3.1. Create a VM on Azure.</a></li>
<li><a href="#orgheadline5">1.3.2. Configure Unix Shell to Interact with New Azure VM.</a></li>
<li><a href="#orgheadline6">1.3.3. <code>ssh</code> into VM with <code>docker-machine</code></a></li>
<li><a href="#orgheadline7">1.3.4. Install Package(s) with <code>apt-get</code></a></li>
<li><a href="#orgheadline8">1.3.5. Add <code>ubuntu</code> User to <code>docker</code> Group and Restart Docker</a></li>
<li><a href="#orgheadline9">1.3.6. Restart Azure VM</a></li>
<li><a href="#orgheadline10">1.3.7. <code>ssh</code> into VM</a></li>
<li><a href="#orgheadline11">1.3.8. Install <code>docker-compose</code> on VM</a></li>
</ul>
</li>
<li><a href="#orgheadline27">1.4. LDM and TDS Configuration</a>
<ul>
<li><a href="#orgheadline15">1.4.1. Background</a></li>
<li><a href="#orgheadline16">1.4.2. <code>git clone</code> Repositories</a></li>
<li><a href="#orgheadline24">1.4.3. Configuring the LDM</a></li>
<li><a href="#orgheadline26">1.4.4. Configuring the TDS</a></li>
</ul>
</li>
<li><a href="#orgheadline28">1.5. Setting up Data Volumes</a></li>
<li><a href="#orgheadline29">1.6. RAMADDA Configuration</a></li>
<li><a href="#orgheadline30">1.7. Opening Ports</a></li>
<li><a href="#orgheadline31">1.8. Tomcat Logging for TDS and RAMADDA</a></li>
<li><a href="#orgheadline32">1.9. Starting the LDM TDS RAMADDA TDM</a></li>
<li><a href="#orgheadline33">1.10. Check What is Running</a></li>
</ul>
</li>
</ul>
</div>
...
# LDM, TDS, and RAMADDA on Microsoft Azure VM<a id="orgheadline34"></a>

## Quick Start<a id="orgheadline1"></a>

## Preamble<a id="orgheadline3"></a>

The following instructions describe how to configure a [Microsoft Azure VM](https://azure.microsoft.com) serving data with the [LDM](http://www.unidata.ucar.edu/software/ldm/), [TDS](http://www.unidata.ucar.edu/software/thredds/current/tds/), and [RAMADDA](http://sourceforge.net/projects/ramadda/). This document assumes you have access to Azure resources though these instructions should be fairly similar on other cloud providers (e.g., Amazon). They also assume familiarity with Unix, Docker, and Unidata technology in general. You will have to be comfortable entering command at the Unix command line. We will be using Docker images defined here:  
...
### `ssh` into VM with `docker-machine`<a id="orgheadline6"></a>

    docker-machine ssh unidata-server

### Install Package(s) with `apt-get`<a id="orgheadline7"></a>
...
### Add `ubuntu` User to `docker` Group and Restart Docker<a id="orgheadline8"></a>

    sudo usermod -G docker ubuntu
    sudo service docker restart

### Restart Azure VM<a id="orgheadline9"></a>
...
### `ssh` into VM<a id="orgheadline10"></a>
...
## Setting up Data Volumes<a id="orgheadline28"></a>
...
## RAMADDA Configuration<a id="orgheadline29"></a>

When you fire up RAMADDA for the very first time, you ,ust have  a `password.properties` file in the RAMADDA home directory which is `/data/repository/`. See [RAMADDA documentation](http://ramadda.org//repository/userguide/toc.html) for more details on setting up RAMADDA.
...
## Opening Ports<a id="orgheadline30"></a>
...
## Tomcat Logging for TDS and RAMADDA<a id="orgheadline31"></a>
...
## Starting the LDM TDS RAMADDA TDM<a id="orgheadline32"></a>
...
## Check What is Running<a id="orgheadline33"></a>
