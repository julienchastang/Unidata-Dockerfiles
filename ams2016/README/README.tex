...
\item Run the \texttt{Unidata-Dockerfiles/ams2016/unicloud-1.sh} script (this will take few minutes) to create the Docker host on Azure. See the \hyperref[orgtarget1]{section on Azure} for more information.
\end{itemize}
...
\texttt{ssh} into new Docker host with  \texttt{docker-machine ssh <azure-host>}. See the \hyperref[orgtarget2]{section below} about editing the \texttt{ldmfile.sh} to correctly handle logging. Run \texttt{\textasciitilde{}/git/Unidata-Dockerfiles/ams2016/unicloud-3.sh}. See the section on \hyperref[orgtarget3]{checking} what you have done.
