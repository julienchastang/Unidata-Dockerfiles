...
\item \texttt{ssh ubuntu@unidata-server.cloudapp.net "bash -s" < Unidata-Dockerfiles/ams2016/unicloud-2.sh} (this will take few minutes)
\end{itemize}
