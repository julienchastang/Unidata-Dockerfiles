...
\item Run the \texttt{Unidata-Dockerfiles/ams2016/unicloud-1.sh [-{}-azure-host] [-{}-azure-host]  [-{}-azure-subscription-id]  [-{}-azure-subscription-cert]  [-{}-azure-size]} script (this will take few minutes)
\end{itemize}
