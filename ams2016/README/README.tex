...
\item Run the \texttt{Unidata-Dockerfiles/ams2016/unicloud-1.sh} (this will take few minutes)
\item \texttt{docker-machine ssh unidata-server "bash -s" < Unidata-Dockerfiles/ams2016/unicloud-2.sh} (this will take few minutes)
\end{itemize}


At this point you are almost done. You just need to \texttt{docker-machine ssh} into your new 
...
\end{verbatim}
docker-machine ssh unidata-server
\textasciitilde{}/git/Unidata-Dockerfiles/ams2016/unicloud-3.sh
